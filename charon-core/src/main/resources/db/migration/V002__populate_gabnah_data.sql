...
VALUES(gen_random_uuid(), (SELECT id FROM charon_core.transit_route WHERE code = 'GAB-NAH'), 'vesselfinder', '{"latitude":49.17248,"longitude":-123.90223,"zoom":13,"width":"100%","height":"400","names":false,"fleet":"8307055d37eec012f602eaba7f62ff03","fleetName":"gabnah"}'::jsonb);